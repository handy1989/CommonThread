...
set shortmess=aoO
badd +1 epoll_socket.cpp
badd +1 epoll_socket.h
args epoll_socket.cpp
edit epoll_socket.h
...
exe 'vert 1resize ' . ((&columns * 30 + 85) / 171)
exe 'vert 2resize ' . ((&columns * 29 + 85) / 171)
exe 'vert 3resize ' . ((&columns * 40 + 85) / 171)
exe 'vert 4resize ' . ((&columns * 69 + 85) / 171)
argglobal
enew
file __Tag_List__
let s:cpo_save=&cpo
